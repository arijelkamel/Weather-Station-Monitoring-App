...
class TemperatureStatictis extends StatefulWidget {

  @override
  State<TemperatureStatictis> createState() => _TemperatureStatictisState();
}

class _TemperatureStatictisState extends State<TemperatureStatictis> {
