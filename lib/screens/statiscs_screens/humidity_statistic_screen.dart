...
class HumidityStatistics extends StatefulWidget {
  const HumidityStatistics({super.key});


  @override
  State<HumidityStatistics> createState() => _HumidityStatisticsState();
}

class _HumidityStatisticsState extends State<HumidityStatistics> {
  late List<List<String>>  humidityListCoupleTimeValue ;
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    ...
    return
       Scaffold(
        ...
        body: BodyWidget(day: temperatureListCoupleTimeValue[0],data: temperatureListCoupleTimeValue[1],),
      ...
      children: [
        Row(
          ...
          children: [
            ...
            Text("Humidity %",style: TextStyle(color: Colors.white , fontSize: 30),),
            Spacer(),
          ],
        ),
        SizedBox(height:50,),
