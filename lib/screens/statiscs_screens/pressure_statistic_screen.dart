...
class PressureStatictis extends StatefulWidget {

  @override
  State<PressureStatictis> createState() => _PressureStatictisState();
}

class _PressureStatictisState extends State<PressureStatictis> {
      ...
      children: [
        Row(
          ...
          children: [
            ...
            Text("Pressure",style: TextStyle(color: Colors.white , fontSize: 30),),
            Spacer(),
          ],
        ),
        SizedBox(height:50,),
